...
class Voc(object) : 
    ...
    def build_voc(self) :
        ...
        for fic in self.corpus.lire() : 
            ...
            for item in ficstring.split() :
                if item not in self.voc :
                    self.voc.append(item)
        print(f"\nVOCABULAIRE de l'ensemble des mots du corpus :\n {self.voc}")
    ...
    def clean(self,ficstring) : 
        ...
        ficstring = ficstring.replace('/',' ')
        ficstring = ficstring.replace('\\',' ')
        ficstring = ficstring.replace('<i>','')
        ficstring = ficstring.replace('<hr>','')
        ficstring = ficstring.replace('<','')
        ficstring = ficstring.replace('>','')
...
class Corpus(object) : 
    ...
    def getBOW(self) : 
        ...
        for fic in self.lire() : 
            ...
            #print(liste)
            #print("**********")
            self.bow.append(f"Fichier {fic} : {liste}")
        print ("\nBAG OF WORDS : \n")
        print(self.bow)
